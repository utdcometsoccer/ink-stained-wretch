  ...
  return (
    <form onSubmit={e => { e.preventDefault(); onSave(form); }}>
      <fieldset className="author-doc-form-fieldset">
        <legend className="author-doc-form-legend">{text?.legend}</legend>
        ...
        <div className="author-doc-form-actions">
          <button className="author-doc-form-save-btn" type="submit">{text?.save}</button>
          <button className="author-doc-form-cancel-btn" type="button" onClick={onCancel}>{text?.cancel}</button>
        </div>
      </fieldset>
    </form>
  );
